...
std::string Languages::ukraine(uint8_t textNumber)
{
	switch (textNumber)
	{
	default:	return "Text call error! Код 6\n";
	case 0:		return "Виберіть відповідний режим роботи:\n\n1. Шифрування\n2. Розшифрування\n\n";
	case 10:	return "Помилка! Введіть число зі списку вище.\nНатисніть будь-яку клавішу для повторного введення.\n";
	case 20:	return "Виберіть потрібний варіант:\n\n1. Шифрування рядка\n2. Шифрування txt-файлу\n\n";
	case 30:	return "Введіть повідомлення:\n\n";
	case 31:	return "Введіть пароль користувача для шифрування:\n\n";
	case 32:	return "Введіть кількість алфавітів для генерації.\nЯкщо ви не знаєте, що це таке, пропустіть цей крок, натиснувши enter, буде вибрано значення за замовчуванням:\n\n";
	case 40:	return "\rЦе ваше зашифроване повідомлення!\nКількість літер при генерації: ";
	case 50:	return "Виберіть потрібну опцію:\n\n1. Розшифровка рядка\n2. Розшифрування txt-файлу\n\n";
	case 60:	return "Введіть повідомлення:\n\n";
	case 61:	return "Введіть пароль користувача для розшифрування:\n\n";
	case 62:	return "Введіть кількість алфавітів для генерації.\nЯкщо ви не знаєте, що це таке, пропустіть цей крок, натиснувши enter, буде вибрано значення за замовчуванням:\n\n";
	case 70:	return "\rЦе ваше розшифроване повідомлення!\nКількість літер при генерації: ";
	case 80:	return "Введіть шлях до файлу (абсолютний або відносний):\n\n";
	case 81:	return "Введіть пароль користувача для шифрування:\n\n";
	case 82:	return "Введіть кількість алфавітів для генерації.\nЯкщо ви не знаєте, що це таке, пропустіть цей крок, натиснувши enter, буде вибрано значення за замовчуванням:\n\n";
	case 90:	return "Ваш файл успішно зашифровано!\nКількість літер при генерації: ";
	case 180:	return "Введіть шлях до файлу (абсолютний або відносний):\n\n";
	case 181:	return "Введіть пароль користувача для розшифрування:\n\n";
	case 182:	return "Введіть кількість алфавітів для генерації.\nЯкщо ви не знаєте, що це таке, пропустіть цей крок, натиснувши enter, буде вибрано значення за замовчуванням:\n\n";
	case 190:	return "Ваш файл успішно розшифровано!\nКількість літер при генерації: ";
	}
}
...
std::string Languages::getText(uint8_t textNumber)
{
	...
	if (language == "en")	return english(textNumber);
	if (language == "uk")	return ukraine(textNumber);
}
